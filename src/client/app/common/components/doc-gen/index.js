...
export class DocGen extends React.Component {
  componentDidMount() {
      ...
      $(go.Node, "Auto",
        ...
        $(go.Panel, "Table",
          ...
          $("PanelExpanderButton", "PROPERTIES",
            ...
            new go.Binding("visible", "libraries", function(arr) { return arr.length > 0; })),
          ...
          $("PanelExpanderButton", "METHODS",
            ...
            new go.Binding("visible", "components", function(arr) { return arr.length > 0; })),
          ...
          $("PanelExpanderButton", "METHODS",
            ...
            new go.Binding("visible", "rules", function(arr) { return arr.length > 0; })),
        ...
        // Reducer
          ...
          $("PanelExpanderButton", "METHODS",
            ...
            new go.Binding("visible", "reducer", function(arr) { return arr.length > 0; })),
        )
      );
